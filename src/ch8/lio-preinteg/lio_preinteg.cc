...
void LioPreinteg::PCLCallBack(const sensor_msgs::msg::PointCloud2::SharedPtr &msg) { sync_->ProcessCloud(msg); }

void LioPreinteg::LivoxPCLCallBack(const livox_ros_driver2::CustomMsg::SharedPtr &msg) { sync_->ProcessCloud(msg); }
