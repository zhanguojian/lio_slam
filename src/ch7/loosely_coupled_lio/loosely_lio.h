...
#include "ch7/loosely_coupled_lio/cloud_convert.h"  // 包含简化的 livox_ros_driver2 定义
...
class LooselyLIO {
   public:
    ...
    void LivoxPCLCallBack(const livox_ros_driver2::CustomMsg::SharedPtr &msg);
